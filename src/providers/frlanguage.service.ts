...
export class FrLanguageServices {
    ...
    constructor(){
        ...
        //this.labelList["label33"]   = "Le mot de passe doit comporter 6 caractères et doit contenir au moins une lettre majuscule, une lettre minuscule, un chiffre, un caractère spécial (ne peut être que  # $ ^ + = ! * ( ) @ % &) par exemple Pass@123";
        this.labelList["label33"]   = "Le mot de passe doit comporter au moins 6 caractères (E.g: jobtek)" 
        ...
        this.labelList["label114"]  = "Nom du Responsable";
        ...
        this.labelList["label141"]  = "Le candidat devra dormir sur place?";
       ...
       // this.labelList["label162"] = "Preuve d'identité (devant)";
        ...
        this.labelList["label161"] = "Photo de profil ou logo pour agence";
        this.labelList["label162"] = "Pièce d’identité (Recto)";
        this.labelList["label163"] = "Pièce d’identité (Verso)";
        this.labelList["label164"] = "ans";
        this.labelList["label165"] = "Voulez-vous enregistrer cette demande en tant que favoris?";
        this.labelList["label166"]   = "Avis de candidats et évaluations";
        this.labelList["label167"]   = "Commenté sur";
        this.labelList["label168"]   = "Aucun avis et évaluations pour cette demande d'emploi";
        this.labelList["label169"]   = "L’option d’inscription des candidats sera disponible une fois que votre compte sera validé par l’Admin. N'oubliez surtout pas de télécharger une pièce d'identité (recto /verso) pour permettre à l'Admin de valider votre compte";
        this.labelList["label170"]   = "Adulte";
        this.labelList["label171"]   = "Les enfants";
        this.labelList["label172"]   = "Téléphone";
        this.labelList["label173"]   = "Contactez nous";
        this.labelList["label174"]   = "Termes et conditions";
        this.labelList["label175"]   = "Retour à l'inscription";
        this.labelList["label176"]   = "Verify you tel number";
        this.labelList["label177"]   = "Enter the code to 6 digits received to you number";
        this.labelList["label178"]   = "Enter the code here";
        this.labelList["label179"]   = "Send OTP";

        this.labelList["label180"]   = "Vérification du numéro de téléphone";
        this.labelList["label181"]   = "Valider";
        this.labelList["label182"]   = "Annuler";
        this.labelList["label183"]   = "En cliquant sur « Valider » un SMS vous seras envoyé";
        this.labelList["label184"]   = "Entrer le code à 6 digits reçu sur votre numéro de téléphone";
        this.labelList["label185"]   = "Entrer le code ici";
        this.labelList["label186"]   = "Continuer";
        this.labelList["label187"]   = "En cliquant sur « Continuer » vous allez confirmer le code";
        this.labelList["label188"]   = "Renvoyer le code";

        this.labelList["label189"]   = "Cochez les compétences du candidat et mettez une description"; //for label130
        this.labelList["label190"]   = "Quelle est la disponibilité du candidat?"; // for label67
        this.labelList["label191"]   = "Quelle est  le nombre d’année d’expérience du candidat?"; // for label65
        ...
        this.labelList["validmsg26"] = "Unicode est requis";
        this.labelList["validmsg27"] = "veuillez accepter les termes et conditions";
        this.labelList["validmsg28"] = "Vous avez entré une adresse email invalide";
        ...
        this.labelList["errormsg35"]  = "Captcha invalide";
        this.labelList["errormsg36"]  = "Pin incorrect";
        this.labelList["errormsg37"]="Impossible de demander le code PIN. S'il vous plaît essayer après quelque temps";
        this.labelList["errormsg38"]="est déjà utilisé. S'il vous plaît, utilisez une autre adresse pour l'inscription.";
        ...
        this.labelList["successmsg5"]   = "Renvoyez le code PIN avec succès. Vérifiez votre numéro de téléphone et entrez le code";
        this.labelList["successmsg6"]   = "NIP envoyé avec succès. Veuillez vérifier votre numéro de téléphone et entrer le code";
        ...
        this.labelList["menu2"]  ="Rechercher une annonce";
        this.labelList["menu3"]  ="Créer une annonce 'Candidat'";
        ...
        this.labelList["menu7"]  ="Créer une annonce 'Employeur'";
        ...
        this.labelList["menu16"] ="Contactez nous";
        this.labelList["menu17"] ="Comment ça marche?";
